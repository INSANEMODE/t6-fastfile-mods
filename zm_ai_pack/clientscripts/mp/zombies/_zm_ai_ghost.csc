...
register_client_fields()
{
	...
	register_clientfield_alt( "actor", "ghost_fx", "int", ::play_fx_clientfield_cb );

	//registerclientfield( "actor", "sndGhostAudio", 12000, 3, "int", ::sndghostaudio, 0 );
	register_clientfield_alt( "actor", "sndGhostAudio", "int", ::sndghostaudio );

	//registerclientfield( "scriptmover", "ghost_fx", 12000, 3, "int", ::play_fx_clientfield_cb, 0 );
	register_clientfield_alt( "scriptmover", "ghost_fx", "int", ::play_fx_clientfield_cb );
	//registerclientfield( "scriptmover", "sndGhostAudio", 12000, 3, "int", ::sndghostaudio, 0 );
	register_clientfield_alt( "scriptmover", "sndGhostAudio", "int", ::sndghostaudio );
