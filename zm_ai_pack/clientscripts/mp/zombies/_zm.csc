...
zombie_ragdoll_explode_cb_alt( new_val )
{
	if ( !isdefined( self.zombie_gut_explosion_cb_alt_old_val ) )
	{
		self.zombie_gut_explosion_cb_alt_old_val = 0;
	}
	newval = int( new_val );
	oldval = self.zombie_gut_explosion_cb_alt_old_val;
	if ( getDvarInt( "clientfield_alt_zm_debug" ) )
	{
		print( "zombie_ragdoll_explode_cb_alt( " + oldval + ", " + newval + " )" );
	}
	if ( newval )
		self zombie_wait_explode( 0 );
}
...
zombie_gut_explosion_cb_alt( new_val)
{
	if ( !isdefined( self.zombie_gut_explosion_cb_alt_old_val ) )
	{
		self.zombie_gut_explosion_cb_alt_old_val = 0;
	...
	if ( getDvarInt( "clientfield_alt_zm_debug" ) )
	{
		print( "zombie_gut_explosion_cb_alt( " + oldval + ", " + newval + " )" );
	}
	if ( newval )
	{
		if ( isdefined( level._effect["zombie_guts_explosion"] ) )
		{
			...
			if ( isdefined( org ) )
				playfx( 0, level._effect["zombie_guts_explosion"], org );
		}
	}
}
