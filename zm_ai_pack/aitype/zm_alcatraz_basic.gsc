...
{
    self.accuracy = 1;
    self.animstatedef = "zm_prison_basic.asd";
    self.animtree = "zm_prison_basic.atr";
    self.csvinclude = "";
    ...
    {
        case 0:
            character\c_zom_guard::main();
            break;
        case 1:
            character\c_zom_inmate1::main();
            break;
        case 2:
            character\c_zom_inmate2::main();
            break;
    }
