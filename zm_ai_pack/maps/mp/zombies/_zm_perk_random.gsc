...
init()
{
    ...
    scripts\zm\clientfield_alt_sys::register_clientfield_alt( "scriptmover", "perk_bottle_cycle_state" );
	scripts\zm\clientfield_alt_sys::register_clientfield_alt( "scriptmover", "turn_active_perk_light_red" );
	scripts\zm\clientfield_alt_sys::register_clientfield_alt( "scriptmover", "turn_active_perk_light_green" );
	scripts\zm\clientfield_alt_sys::register_clientfield_alt( "scriptmover", "turn_on_location_indicator" );
	scripts\zm\clientfield_alt_sys::register_clientfield_alt( "scriptmover", "turn_active_perk_ball_light" );
	scripts\zm\clientfield_alt_sys::register_clientfield_alt( "scriptmover", "zone_captured" );
...
{
    set_clientfield_alt_allplayers( "zone_captured", self, 1 );
    wait 1;
    set_clientfield_alt_allplayers( "zone_captured", self, 0 );
...
conditional_power_indicators()
{
    ...
    {
        set_clientfield_alt_allplayers( "turn_active_perk_light_red", self, 0 );
        set_clientfield_alt_allplayers( "turn_active_perk_light_green", self, 0 );
        set_clientfield_alt_allplayers( "turn_active_perk_ball_light", self, 0 );
        set_clientfield_alt_allplayers( "zone_captured", self, 0 );
    }
    else if ( self.is_current_ball_location )
    {
        set_clientfield_alt_allplayers( "turn_active_perk_light_red", self, 0 );
        set_clientfield_alt_allplayers( "turn_active_perk_light_green", self, 1 );
        set_clientfield_alt_allplayers( "turn_active_perk_ball_light", self, 1 );
        set_clientfield_alt_allplayers( "zone_captured", self, 1 );
    }
    else
    {
        set_clientfield_alt_allplayers( "turn_active_perk_light_red", self, 1 );
        set_clientfield_alt_allplayers( "turn_active_perk_light_green", self, 0 );
        set_clientfield_alt_allplayers( "turn_active_perk_ball_light", self, 0 );
        set_clientfield_alt_allplayers( "zone_captured", self, 1 );
    }
...
machine_think()
{
    ...
    set_clientfield_alt_allplayers( "turn_on_location_indicator", self, 1 );
    ...
    while ( true )
    {
        ...
        if ( self.num_time_used >= self.num_til_moved )
        {
            ...
            set_clientfield_alt_allplayers( "turn_on_location_indicator", self, 0 );
        ...
        while ( true )
        {
            ...
            set_clientfield_alt_allplayers( "perk_bottle_cycle_state", self, 1 );
            level notify( "pmstrt" );
            wait 1.0;
            ...
            if ( self.num_time_used >= self.num_til_moved )
            {
                ...
                level notify( "random_perk_moving" );
                set_clientfield_alt_allplayers( "perk_bottle_cycle_state", self, 0 );
                set_clientfield_alt_allplayers( "turn_on_location_indicator", self, 0 );
                self.is_current_ball_location = 0;
                self conditional_power_indicators();
                self hidepart( "j_ball" );
