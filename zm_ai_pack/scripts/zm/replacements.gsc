...
init_override()
{
	...
	//scripts\zm\clientfield_alt_sys::register_clientfield_alt( "actor", "zombie_has_eyes" );

	registerclientfield( "actor", "zombie_ragdoll_explode", 1, 1, "int" );
	//scripts\zm\clientfield_alt_sys::register_clientfield_alt( "actor", "zombie_ragdoll_explode" );

	registerclientfield( "actor", "zombie_gut_explosion", 9000, 1, "int" );
	//scripts\zm\clientfield_alt_sys::register_clientfield_alt( "actor", "zombie_gut_explosion" );
